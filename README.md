# Qoppy - React Native Clipboard Manager

A polished, production-ready clipboard manager built with Expo + React Native.
Save text snippets, tap once to copy, organize with categories.
...
3. `glowOpacity` - fades in a success-colored border ring, then out
...
- Optimized JOIN queries - category name/color arrive with each snippet in one round-trip
...
- `assets/splash.png` - 1284x2778 (or use `resizeMode: contain`)
- `assets/adaptive-icon.png` - 1024x1024 (Android foreground)
- `assets/favicon.png` - 32x32 (web)
